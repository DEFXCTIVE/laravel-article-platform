    ...
    <div class="container-sm my-md-3">
        ...
        <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" accept=".png,.jpg,.gif" type="file" name="Image" id="formImageFile" required /></input>
            </div>
            <div class="mb-3">
                <label for="input_tags" class="form-label">Tags</label>
                <select class="form-select" id="input_tags" name="tags_json[]" multiple    data-allow-new="false" data-server="{{ route('tags.autocomplete') }}" data-live-server="1" data-allow-clear="true">
                    <option disabled hidden value="">Choose a tag...</option>
                </select>
            </div>
            <div class="mb-3">
                <label for="input_cats" class="form-label">Category</label>
                <select class="form-select" id="input_cats" name="cats_json[]"  data-allow-clear="1" data-suggestions-threshold="0"  data-allow-new="false" data-server="{{ route('cats.autocomplete') }}" data-live-server="1" data-allow-clear="true">
